...
{
    [ApiVersion("1.0")]
    [ApiExplorerSettings(GroupName = "Umbraco.Community.KeyValuesPropertyEditor")]
    public class UmbracoCommunityKeyValuesPropertyEditorApiController : UmbracoCommunityKeyValuesPropertyEditorApiControllerBase
    {
        private readonly IBackOfficeSecurityAccessor _backOfficeSecurityAccessor;

        public UmbracoCommunityKeyValuesPropertyEditorApiController(IBackOfficeSecurityAccessor backOfficeSecurityAccessor)
        {
