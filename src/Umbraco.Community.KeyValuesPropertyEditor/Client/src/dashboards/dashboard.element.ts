...
import { UmbracoCommunityKeyValuesPropertyEditorService, UserModel } from "../api";
...
export class ExampleDashboardElement extends UmbElementMixin(LitElement) {
  ...
  #onClickWhoAmI = async (ev: Event) => {
    ...
    const { data, error } = await UmbracoCommunityKeyValuesPropertyEditorService.whoAmI();
  ...
  #onClickWhatsTheTimeMrWolf = async (ev: Event) => {
    ...
    const { data, error } = await UmbracoCommunityKeyValuesPropertyEditorService.whatsTheTimeMrWolf();
  ...
  #onClickWhatsMyName = async (ev: Event) => {
    ...
    const { data, error } = await UmbracoCommunityKeyValuesPropertyEditorService.whatsMyName();
