...
var U = (s, e, a) => e in s ? C(s, e, { enumerable: !0, configurable: !0, writable: !0, value: a }) : s[e] = a;
var g = (s, e, a) => U(s, typeof e != "symbol" ? e + "" : e, a);
var A = /\{[^{}]+\}/g, b = ({ allowReserved: s, name: e, value: a }) => {
  if (a == null) return "";
  ...
  let e = j(T(), s), a = () => ({ ...e }), i = (t) => (e = j(e, t), a()), l = D(), n = async (t) => {
    ...
    let m = p;
    for (let f of l.error._fns) m = await f(p, u, c, r);
...
class M {
  static ping(e) {
    return ((e == null ? void 0 : e.client) ?? y).get({
      ...e,
      url: "/umbraco/umbracocommunitykeyvaluespropertyeditor/api/v1/ping"
    });
  }
  static whatsMyName(e) {
    return ((e == null ? void 0 : e.client) ?? y).get({
      ...e,
      url: "/umbraco/umbracocommunitykeyvaluespropertyeditor/api/v1/whatsMyName"
    });
  }
  static whatsTheTimeMrWolf(e) {
    return ((e == null ? void 0 : e.client) ?? y).get({
      ...e,
      url: "/umbraco/umbracocommunitykeyvaluespropertyeditor/api/v1/whatsTheTimeMrWolf"
    });
  }
  static whoAmI(e) {
    return ((e == null ? void 0 : e.client) ?? y).get({
      ...e,
      url: "/umbraco/umbracocommunitykeyvaluespropertyeditor/api/v1/whoAmI"
    });
  }
}
export {
...
//# sourceMappingURL=services.gen-xSV3RQfg.js.map
