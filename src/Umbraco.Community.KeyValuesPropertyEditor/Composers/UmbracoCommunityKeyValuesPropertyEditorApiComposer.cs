...
namespace Umbraco.Community.KeyValuesPropertyEditor.Composers
{
    public class UmbracoCommunityKeyValuesPropertyEditorApiComposer : IComposer
    {
        public void Compose(IUmbracoBuilder builder)
        {
            ...
            builder.Services.Configure<SwaggerGenOptions>(opt =>
            {
                ...
                {
                    Title = "Umbraco Community Key Values Property Editor Backoffice API",
                    Version = "1.0",
                ...
                opt.OperationFilter<UmbracoCommunityKeyValuesPropertyEditorOperationSecurityFilter>();
            });
        }

        public class UmbracoCommunityKeyValuesPropertyEditorOperationSecurityFilter : BackOfficeSecurityRequirementsOperationFilterBase
        {
        ...
        public class CustomOperationHandler : OperationIdHandler
        {
            ...
            {
                return controllerActionDescriptor.ControllerTypeInfo.Namespace?.StartsWith("Umbraco.Community.KeyValuesPropertyEditor.Controllers", comparisonType: StringComparison.InvariantCultureIgnoreCase) is true;
            }
